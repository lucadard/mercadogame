  ...
  return (
    <>
      ...
      <nav className="bg-mercadolibre-primary grid grid-rows-2 lg:grid-rows-1 lg:grid-flow-col border-b-[1px] border-gray-300 py-2 px-10 gap-y-2 text-md lg:text-lg">
        ...
        {/* logo */}
        <a
          className="row-start-1 font-sans flex gap-2 items-center lg:justify-self-center"
          href="/"
        >
          <img
            src="/mercadogame.svg"
        ...
        {/* leaderboard */}
        <div className="row-start-1 place-self-end self-center">
          <button
            className={`border-[1px] h-10 px-3 rounded-lg hover:border-mercadolibre-btn  
        ${
          isBtnClicked
